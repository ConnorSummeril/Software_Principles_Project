...
public class FourBitTwoTest {
    ...
    public void testDefault1() {
      FourBitTwoDisclosureDeviceUnlocker test17 = new 
                FourBitTwoDisclosureDeviceUnlocker();
       // boolean [] testArray16 = {true, true, true, true};
       Device device17 = new Device();
       assertThat(test17.unlock(device17), is(true));
    }

    @Test
    public void testDefault2() {
      FourBitTwoDisclosureDeviceUnlocker test18 = new 
                FourBitTwoDisclosureDeviceUnlocker();
       // boolean [] testArray16 = {true, true, true, true};
       Device device18 = new Device(4, 2);
       assertThat(test18.unlock(device18), is(true));
    }
